...
var watchMatchTile = ( function (){
	...
	function _Init ( elTile, oMatch, oTeam1, oTeam2 )
	{
		...
		function _CreateTeamPanelsInContainerPanel ( elTeamContainer, teamNum, oTeam )
		{
			...
			var elTeamLogo = $.CreatePanelWithProperties( "Image", elTeamContainer, 'id-wmt-logo-' + teamName, { 
				class: 'wmt__datum wmt__datum--teamlogo img-shadow',
				clampfractionalpixelpositions: 'false',
				src: teamLogo
			} );

			var elLabel = $.CreatePanelWithProperties( "Label", elTeamContainer, 'id-wmt-label-' + oMatch[ 'team' + teamNum + '_name' ], { 
		...
		$.CreatePanelWithProperties( "Label", elVersusContainer, 'id-wmt-label-vs', { 
