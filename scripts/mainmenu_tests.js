...
function PanelTypeTab( panelType, layoutType )
{
    ...
    var container = $.CreatePanelWithProperties("Panel", $.FindChildInContext('#TestContent'), panelId, { class: "debug-tester--" + layoutType });
    var debugControls = $.CreatePanelWithProperties("Panel", container, "DebugControls", { class: "debug-tester-controls" });
    var testPanelContainer = $.CreatePanelWithProperties("Panel", container, "", { class: "debug-tester-panelholder" });
