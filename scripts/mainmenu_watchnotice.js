...
var MainmenuWatchNotice = (function () {
	...
	function _PopulateEvent ( oEvent )
	{
		...
		var elCarousel = $.CreatePanelWithProperties( "Carousel", elCarouselContainer, carouselId, { 'autoscroll-delay':"20s"} );
		elCarousel.AddClass( "watchnotice__matches-carousel" );

		$.CreatePanelWithProperties( "CarouselNav", elCarouselContainer, "Match-Carousel-Nav--" + oEvent[ 'event_id' ],
			{
