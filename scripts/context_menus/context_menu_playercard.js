...
var contextmenuPlayerCard = ( function (){
	...
	{
		$.CreatePanelWithProperties('Panel', $.GetContextPanel(), '', { class: 'context-menu-playercard-seperator' } );
		var elContextMenuBtns = $.CreatePanelWithProperties('Panel', $.GetContextPanel(), 'JsContextMenuPlayercardBtns', { class: 'context-menu-playercard-btns' } );
		...
		_ContextMenus.forEach( function( entry ) {
			if ( entry.AvailableForItem( xuid )) 
			{
				...
				if ( 'xml' in entry )                                 
				{
					elEntryBtn = $.CreatePanelWithProperties( 'Panel', elContextMenuBtns, entry.name, { 
						class: 'IconButton',
				...
				{
					elEntryBtn = $.CreatePanelWithProperties( 'Button', elContextMenuBtns, entry.name, { 
						class: 'IconButton',
						style: 'tooltip-position: bottom;'
					} );

					$.CreatePanelWithProperties( 'Image', elEntryBtn, entry.name, { src: 'file://{images}/icons/ui/' + entry.icon + '.svg' } );
