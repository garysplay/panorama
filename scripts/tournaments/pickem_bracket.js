...
var PickEmBracket = ( function()
{
	...
	{	
		...
		elTeam._oteamData.dragStartHandle = $.RegisterEventHandler( 'DragStart', elTeam, function ( targetId, obj ) {
			...
			var elDraggable = $.CreatePanelWithProperties( "Panel", elTeam, 'draggable' + elTeam._oteamData.teamid, {
				class: 'pickem-bracket-draggable'
			} );
			
			$.CreatePanelWithProperties( "Image", elDraggable, 'draggable' + elTeam._oteamData.teamid, {
			...
			$.CreatePanelWithProperties( "Label", elDraggable, 'draggable' + elTeam._oteamData.teamid, {
