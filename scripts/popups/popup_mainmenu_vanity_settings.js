...
var PopupVanitySettings = ( function(){
	...
	var _SetSubCategories = function ( subCategories )
	{
		for( var i = 0; i < subCategories.length; i++ )
		{
			...
			var optionLabel = $.CreatePanelWithProperties('Label', $('#VanityDropdownSubCatagories'), displayString, { text: displayString });
	...
	{	
		...
		var elDropDown = $.CreatePanelWithProperties('DropDown', $('#VanityDropdownWeapons'), 'VanityDropdownGroups', { class:'PopupButton'} );
	...
	var AddOptionToGroups = function ( elDropDown, itemId, group )
	{
		...
		var optionLabel = $.CreatePanelWithProperties('Label',elDropDown, group, { text: displayString });
